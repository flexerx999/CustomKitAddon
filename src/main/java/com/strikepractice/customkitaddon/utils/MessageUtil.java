...
public class MessageUtil {
    ...
    private static final String PREFIX = "&b&lCustomKit &8» &7";
    ...
    public static void sendCentered(Player player, String message) {
        player.sendMessage(getCenteredMessage(color(message)));
    }
    ...
    /**
     * Font information for centering
     */
